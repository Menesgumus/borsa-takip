...
down_revision: str | Sequence[str] | None = "e62787ff07e6"
...
risktolerance_enum = postgresql.ENUM(
    "LOW", "MEDIUM", "HIGH", name="risktolerance", create_type=False
)
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["portfolio_id"], ["portfolios.id"], name=op.f("positions_portfolio_id_fkey")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["portfolio_id"], ["portfolios.id"], name=op.f("trades_portfolio_id_fkey")
        ),
