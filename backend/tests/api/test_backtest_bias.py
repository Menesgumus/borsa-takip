...
from app.db.models import FundamentalData, Instrument, InstrumentType, OHLCVDaily
...
async def test_backtest_publication_timing():
    ...
    async with async_session_maker() as db_session:
        ...
        t0 = datetime.datetime(2025, 3, 31, tzinfo=datetime.timezone.utc)
        t5 = datetime.datetime(2025, 5, 10, tzinfo=datetime.timezone.utc)
        ...
        t4 = datetime.datetime(2025, 5, 9, tzinfo=datetime.timezone.utc)
...
async def test_backtest_same_candle_execution():
    ...
    t1_close = datetime.datetime(2025, 5, 1, 18, 0, tzinfo=datetime.timezone.utc)
    t2_open = datetime.datetime(2025, 5, 2, 9, 30, tzinfo=datetime.timezone.utc)
