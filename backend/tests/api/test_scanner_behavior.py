...
from app.db.models import Instrument, Portfolio, InstrumentType
...
async def test_scanner_same_instrument_different_portfolios():
    async with async_session_maker() as db:
        ...
        p1 = Portfolio(user_id=1, name="Safe", portfolio_type="REAL")
        p2 = Portfolio(user_id=1, name="Aggressive", portfolio_type="REAL")
