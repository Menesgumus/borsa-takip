...
from app.db.models import (
    PositionLifecycle, PositionLifecycleSnapshot,
    LifecycleHealthState, LifecycleAction,
    Instrument, Portfolio, PortfolioTransaction, User,
    DecisionSnapshot, AssetClass, FundamentalData, OHLCVDaily
)
from app.services.decision_engine import (
    evaluate_decision, TechnicalInputs, FundamentalInputs, 
    NewsInputs, DecisionResult, Horizon, ENGINE_VERSION
)
...
async def _get_latest_completed_ohlcv_date(db: AsyncSession, instrument_id: int) -> Optional[str]:
...
async def _get_latest_fundamental_version(db: AsyncSession, instrument_id: int) -> Optional[str]:
...
def compute_market_observation_key(
    instrument_id: int, 
    latest_completed_ohlcv_date: Optional[str], 
    latest_fundamental_version: Optional[str],
