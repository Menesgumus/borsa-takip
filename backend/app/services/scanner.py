...
from app.db.models import Instrument, Portfolio, DecisionSnapshot
from app.schemas.scanner import OpportunityResult

from app.services.decision_engine import evaluate_decision
from app.db.models import FundamentalData
from app.schemas.decision import TechnicalInputs, FundamentalInputs, NewsInputs, Horizon, PortfolioFitInputs


async def scan_opportunities(db: AsyncSession, portfolio_id: Optional[int] = None) -> List[OpportunityResult]:
